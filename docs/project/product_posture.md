...
3. Keep AK-native direction (`SF01`, completed `WW01`/`WW02`, current `WW03`) linked to concrete tasks/evidence as the evidence-backed healing and release-readiness frontier advances instead of reviving handoff files or markdown micro-plans.

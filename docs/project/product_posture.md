...
3. Keep AK-native direction (`SF1`, completed `IW1`/`IW2`/`IW3`, current active `IW4`) linked to concrete tasks/evidence as the multi-component propagation synthesis frontier advances instead of reviving handoff files or markdown micro-plans.
